...
public class CandidoDataSourceConfigurationConstant extends HikariConfig {
    ...
    public final static String REPOSITORY_BASE_PACKAGES = "com.candido.server.repository.v1.candido";
    ...
    public final static String MODEL_PACKAGE = "com.candido.server.domain.v1.candido";
}
